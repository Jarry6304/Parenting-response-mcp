...
變體擴充原則:F3/F5 以搭配結構錨定,不攔裸詞(見文件「在地化備註」)。
"""
...
OUTPUT_PATTERN_F2 = r"你就是|豬腦|豬頭|沒長腦|羞羞臉|丟不丟臉|沒用|廢物|像什麼樣子|哭什麼哭|撿角|沒出息|死小孩|死囝仔|夭壽"
OUTPUT_PATTERN_F3 = r"你看(哥哥|姊姊|弟弟|妹妹)|人家.{0,6}都(可以|會|行)|別人家的?(小孩|孩子)|跟你(爸|媽)一(個樣|樣)|全班就你|同學都|都比你(乖|懂事|好|強)"
OUTPUT_PATTERN_F5 = r"每次都|從來(不|沒)|又來了|又開始了|早就跟你說|上次(也是|就)|講(過)?幾?(百|十|多少)遍|永遠(學|教)不會"
