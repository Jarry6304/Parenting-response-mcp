...
1. **`parenting-response-mcp-spec-v3.0.md` 是總規格(LOCKED)**;行為與規格衝突 = bug。2026-06 G0 訊號化等 A–K 變更已實作,spec 條目由規格持有者 amend 寫回該檔(版號維持 3.0);標 `superseded` 各檔(含 v2.2)僅供歷史參照。
